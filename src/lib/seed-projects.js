...
export const ALL_PROJECTS = [
  ...
  },
  {
    ...
    fullDesc: "OurVadodara News App is a mobile news application built to help local readers follow Vadodara updates, breaking stories, city events, and community information from a fast, mobile-first experience.",
    ...
    features: [
      "Local news feed for Vadodara updates",
      "Category-based news browsing",
      "Breaking-news and city-update experience",
      "Mobile-first article reading",
      "Push-notification-ready content flow",
      "Scalable news publishing architecture",
    ],
    results: [
      "Dedicated mobile news experience for OurVadodara",
      "Faster access to city updates for local readers",
      "Mobile-first platform for news, events, and community information",
    ],
    liveLink: "",
    githubLink: "",
    stat1Label: "Type", stat1Value: "News App",
    stat2Label: "Focus", stat2Value: "Vadodara",
    stat3Label: "Platform", stat3Value: "Mobile",
    problemStatement: "OurVadodara needed a mobile-first news experience that could help local readers follow city updates, breaking stories, events, and community information without depending only on social media or a desktop website.",
    ...
    caseStudyOutcome: "OurVadodara News App gives the brand a dedicated mobile channel for Vadodara-focused news and community updates, improving access for readers who primarily consume information on phones.",
    featured: false,
  },
    {
    title: "iversity.in",
